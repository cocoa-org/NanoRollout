...
# TTL configuration
from nanorollout.envs.desktop_env.providers.aws.config import ENABLE_TTL, DEFAULT_TTL_MINUTES, AWS_SCHEDULER_ROLE_ARN
from nanorollout.envs.desktop_env.providers.aws.scheduler_utils import schedule_instance_termination


INSTANCE_TYPE = os.getenv("AWS_INSTANCE_TYPE", "t3.large")
...
from nanorollout.envs.desktop_env.providers.base import VMManager

# Import proxy-related modules only when needed
try:
    from nanorollout.envs.desktop_env.providers.aws.proxy_pool import get_global_proxy_pool, init_proxy_pool
