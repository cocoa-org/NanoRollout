...
from brew.harness.utils.artifacts import DATASET_MAPPING
...
def create_environment(
    ...
    if env_type == "docker":
        from brew.envs.docker import DockerEnvironment
    ...
    if env_type == "enroot":
        from brew.envs.enroot import EnrootEnvironment
    ...
    if env_type == "modal":
        from brew.envs.modal import ModalEnvironment
